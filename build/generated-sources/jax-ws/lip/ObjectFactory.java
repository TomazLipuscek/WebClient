...
public class ObjectFactory {
    ...
    private final static QName _OperationResponse_QNAME = new QName("http://lip/", "operationResponse");
    private final static QName _Operation_QNAME = new QName("http://lip/", "operation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: lip
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lip/", name = "operationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lip/", name = "operation")
